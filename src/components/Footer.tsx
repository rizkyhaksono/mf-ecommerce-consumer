        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Your one-stop destination for quality products at amazing prices. Built with modern micro frontend architecture.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/cart" className="text-gray-400 hover:text-purple-400 transition-colors">
                  Cart
                </Link>
              </li>
              <li>
